  ...
  return (
    <footer className="flex items-center justify-between border-t border-[var(--line)] bg-[var(--bg-1)] px-4 py-2.5">
      <div className="flex items-center gap-2">
        <button
          onClick={onPrevious}
          className="flex items-center gap-1 rounded-xl border border-[var(--line)] bg-white/[0.04] px-3 py-1.5 text-[12px] font-medium text-[var(--ink-1)] transition hover:bg-white/[0.08] hover:text-[var(--ink-0)]"
        >
          <ChevronLeft size={15} />
          Previous
        </button>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className={`flex items-center gap-1.5 rounded-xl border px-2.5 py-1.5 text-[12px] font-medium transition ${
            flagged
              ...
              : "border-[var(--line)] bg-white/[0.04] text-[var(--ink-1)] hover:bg-white/[0.08] hover:text-[var(--ink-0)]"
          }`}
        >
        ...
        <button
          ...
          className={`rounded-xl px-5 py-1.5 text-[13px] font-bold shadow-sm transition ${
            submitted
              ? "cursor-not-allowed bg-white/[0.06] text-[var(--ink-muted)]"
              : hasSelection
